...
namespace AuthService.Extension
{
    public static class ConsulBuilderExtension
    {
        ...
        public static IApplicationBuilder RegisterConsul(this IApplicationBuilder app, Microsoft.Extensions.Hosting.IHostApplicationLifetime lifetime, string consulServiceIP, string consulServicePort, string consulServiceName, string healthIP, string healthPort)
        {
...

            {
                ...
                HTTP = $"http://{healthIP}:{healthPort}/home/health",//健康检查地址
